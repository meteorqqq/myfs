...
/*
Clear the bit at `bitno` of bitmap, i.e, set it to 0. If `bitno` is greater than size of the bitmap, undefined behaviour occurs.
*/
int clear_bit(uint8_t **bitmap, uint64_t bitno);

/*
Set the bit at `bitno` of bitmap, i.e, set it to 1. If `bitno` is greater than size of the bitmap, undefined behaviour occurs.
*/
